...
SAFETY_VERSION = "batter_1plus_hit_ranker_savant_light_challenger_v1_hgb_lr005_leaf15_l20005"
...
NUMERIC_FEATURE_CANDIDATES = [
    ...
    "platoon_advantage",
    "batter_savant_context_season_prior",
    "batter_savant_expected_pa_season_prior",
    "batter_savant_expected_bip_season_prior",
    "batter_savant_ev_attempts_season_prior",
    "batter_savant_expected_est_ba_season_prior",
    "batter_savant_expected_est_slg_season_prior",
    "batter_savant_expected_est_woba_season_prior",
    "batter_savant_expected_est_ba_minus_ba_diff_season_prior",
    "batter_savant_expected_est_woba_minus_woba_diff_season_prior",
    "batter_savant_ev_avg_hit_angle_season_prior",
    "batter_savant_ev_anglesweetspotpercent_season_prior",
    "batter_savant_ev_avg_hit_speed_season_prior",
    "batter_savant_ev_max_hit_speed_season_prior",
    "batter_savant_ev_ev95percent_season_prior",
    "batter_savant_ev_brl_percent_season_prior",
    "batter_savant_ev_brl_pa_season_prior",
    "batter_savant_pct_xba_season_prior",
    "batter_savant_pct_xwoba_season_prior",
    "batter_savant_pct_xslg_season_prior",
    "batter_savant_pct_brl_season_prior",
    "batter_savant_pct_exit_velocity_season_prior",
    "batter_savant_pct_hard_hit_percent_season_prior",
    "batter_savant_pct_k_percent_season_prior",
    "batter_savant_pct_bb_percent_season_prior",
    "batter_savant_pct_whiff_percent_season_prior",
    "batter_savant_pct_chase_percent_season_prior",
    "batter_savant_pct_bat_speed_season_prior",
    "batter_savant_pct_squared_up_rate_season_prior",
    "batter_savant_pct_swing_length_season_prior",
]
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out_dir", default="artifacts/mlb/models/batter_1plus_hit_ranker_savant_light_challenger")
